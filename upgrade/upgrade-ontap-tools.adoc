...
* In caso di aggiornamento non HA, riavviare la VM degli strumenti ONTAP per riflettere le modifiche.  In caso di aggiornamento HA, riavviare il primo nodo per riflettere le modifiche sul nodo.
